...
export const apiErrorsEn: ApiErrorsDict = {
  ...
  SOURCE_DATABASE_NAME_REQUIRED: "The connection string must include the database name (e.g. .../mydb?...), not just the cluster.",
...
export const apiErrorsPt: ApiErrorsDict = {
  ...
  SOURCE_DATABASE_NAME_REQUIRED: "A connection string precisa incluir o nome do banco (ex.: .../meubanco?...), não só o cluster.",
